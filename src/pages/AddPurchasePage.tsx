...
export default function AddPurchasePage() {
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    if (!purchaseDate) {
      alert("Please complete Visit Date.")
      return
    }

    if (!purchaseTime) {
      alert("Please complete Visit Time.")
      return
    }
    ...
    try {
      ...
      resetForm()
      setSaveMessage("Visit saved. You can add another one now.")
    } catch (error) {
      console.error("Failed to save purchase:", error)
      alert("Unable to save visit right now. Please try again.")
    } finally {
  ...
  return (
    <>
      <PageIntroPopup
        ...
        title="Add Visit"
        description="Use this page to manually log a visit or scan a receipt to speed things up. Add each item from the visit so BudBalance can track your active grams correctly."
      />
      ...
      <div className="space-y-4">
        <div className="px-1">
          ...
          <h2 className="mt-1 text-lg font-semibold text-white">Add Visit</h2>
          <p className="mt-1 text-xs text-slate-400">
            Capture a receipt or log a dispensary visit with multiple items.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <div className="space-y-5">
              ...
              <div className="border-t border-white/10 pt-5">
                <div className="flex items-start justify-between gap-3">
                  <div>
                    ...
                    <p className="mt-1 text-xs text-slate-400">
                      These details apply to the whole visit/receipt.
                    </p>
                  </div>
                  ...
                  <button
                    ...
                    aria-label={
                      isPurchaseDetailsOpen
                        ? "Collapse visit details"
                        : "Expand visit details"
                    }
                ...
                {isPurchaseDetailsOpen && (
                  <div className="mt-3 space-y-3">
                    ...
                    <div>
                      ...
                      <textarea
                        ref={notesRef}
                        placeholder="Optional notes for the whole visit"
                        value={notes}
              ...
              <div className="border-t border-white/10 pt-5">
                <div className="mb-3">
                  ...
                  <p className="mt-1 text-xs text-slate-400">
                    Add every product from this visit.
                  </p>
                </div>
          ...
          <button
            type="submit"
            disabled={isSavingPurchase || !currentUser}
